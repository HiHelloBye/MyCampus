...
<table style="margin-left:auto; margin-right:auto">
	<tr align="center"><th style="background-color:#67aeca">강의 번호 </th><td>${lecture.lec_no }</td></tr>
	<tr align="center"><th style="background-color:#67aeca">대학 번호 </th><td>${lecture.uni_no }</td></tr>
	<tr align="center"><th style="background-color:#67aeca">강의 명   </th><td>${lecture.lec_name }</td></tr>
	<tr align="center"><th style="background-color:#67aeca">교수 이름 </th><td>${lecture.prof_name }</td></tr>
	
	<tr align="right"><td colspan="4"> 
			<input type="button" value="목록" 
			onclick="location.href='lecturelist.do'">
		    <input type="button" value="수정" 
			onclick="location.href='lectureupdateForm.do?lec_no=${lecture.lec_no}'">
</table>
</body>
</html>