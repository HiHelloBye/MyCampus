					...
					<div class="container">
						...
						<!-- Nav -->
								...
								<ul>
									...
									<li><a class="icon fa-cog" href="./StudyList.do"><span>스터디</span></a></li>
									<c:if test="${sessionScope.member_grade eq  0}">
										<li><a class="icon fa-retweet" href="../admin"><span>관리자 페이지</span></a></li>
            ...
            <div class="container"> 
					<div class="ui-widget">
						<form action="EdyStudySearch.do">
							<strong>검색:</strong>&nbsp;<input id="tags1" name="keywordStudy"required minlength="2"> <input type="submit" value="검색">
						</form>
					</div>
				</div>
			</section>
