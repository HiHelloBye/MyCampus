...
<form action="studyWrite.do" method="post"name="frm">
	...
	<table>
		<tr>
			<th style="width:100px;">제목 : </th><td><input type="text" name="study_title"maxlength="50"required="required"></td>
		</tr>
		<tr>
		...
		<tr>
			<th>내용 : </th><td>
			<textarea name="study_cont" id="smarteditor" rows="10" cols="100" style="width:766px; height:412px;"></textarea>
			<!-- <textarea style="resize: none;" name="study_cont" rows="4" cols="50"required="required"></textarea> --></td>
		</tr>
